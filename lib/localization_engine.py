...
class LocalizationEngine:
    ...
    def localize(self, image_arr: np.ndarray, fov_deg: float = None, return_details: bool = False, top_k_db: int = 10):
        # ... (前面的 Image Preprocessing 與 Global Feature 提取保持不變) ...
        ...
        for _, block_name, sim_matrix in candidate_blocks:
            ...
            # Update Fail Stats (If this is the Top1 Block)
            if block_name == diag['top1_block']:
                 ...
                 best_fail_stats['db_ranks'] = current_db_ranks # [New] 記錄失敗時的 Retrieval 詳情
            ...
            try:
                ...
                if success and qvec is not None:
                    ...
                    res_diag.update({
                        ...
                        'status': 'Success',
                        'db_ranks': current_db_ranks # [New] 記錄成功時的 Retrieval 詳情
                    })
